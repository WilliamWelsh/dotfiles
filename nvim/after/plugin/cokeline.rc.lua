...
local components = {
	...
	devicon = {
		...
		style = function(_)
			return
(mappings.is_picking_focus() or mappings.is_picking_close()) and "italic,bold" or nil
		end,
		truncation = { priority = 1 },
	},
...
require("cokeline").setup({
	...
	default_hl = {
		fg = function(buffer)
			return
buffer.is_focused and "#C0C4C2" or "#8A8C8A"
		end,
		bg = function(buffer)
			return
buffer.is_focused and "#1D1F21" or "#151718"
		end,
	},
