return {
	...
	config = function()
		...
		require("cokeline").setup({
			...
			default_hl = {
				fg = function(buffer)
					return buffer.is_focused and "#C0C4C2" or "#8A8C8A"
				end,
				bg = function(buffer)
					return buffer.is_focused and "#1D1F21" or "#151718"
				end,
			},

			components = {
				components.space, -- components.separator,
				-- components.space,
				components.devicon,
				components.space, -- components.index,
